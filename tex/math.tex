...
\begin{outline} 
\item $\Phi$ maps spheres passing through $N$ to planes, and spheres not passing through $N$ to spheres (not passing through $N$). More precisely:
\1 If $S$ is a sphere with diameter $NA$, then $\Phi(S)$ is the plane through $\Phi(A)$ orthogonal to $NA$, and
...
\end{outline}
\item The sterographic projection maps circles not through $N$ to circles in the plane bijectively.
\\
