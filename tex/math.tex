...
Except for brilliant insights which can appear to just come out of the blue, the reader must be motivated (i.e. feel it is natural) to explore an idea. As a corollary, proofs should often precede theorems (simply a reasoning with fruits).\\\\
